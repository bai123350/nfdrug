...
def read_global_graph(thres_score):
    ...
    with open('/home/bio-17/projects/drug/nf_drug/nfdrug/data/9606.protein.info.v11.5.txt') as f:
    ...
    graph_dicts = {}
    graph_dicts['nodes'] = {}
    with open('/home/bio-17/projects/drug/nf_drug/nfdrug/data/9606.protein.links.full.v11.5.txt') as f:
        for idx, line in enumerate(f.readlines()):
            if idx == 0:
                continue
            line = line.split()
...
def read_patient_info(gene_list):
    csv_reader = csv.reader(open("/home/bio-17/projects/drug/nf_drug/nfdrug/data/tnbc2022_448s_gene_tpm_matrix.csv"))
    first_line = True
    X_index = {}
    ...
    pos_id_needed = []
    y_survival = {}
    with open("/home/bio-17/projects/drug/nf_drug/nfdrug/codes/BFregNN-Cox-for-pyroptosis-in-TNBC/data/fuscctnbc_clinical_patient.txt","r") as f:
        for line in f:
