...
if os.path.exists('/home/bio-17/projects/drug/nf_drug/nfdrug/codes/BFregNN-Cox-for-pyroptosis-in-TNBC/data/ppi_global_graph_'+str(args.score)+'.pkl'):
    ...
    with open('/home/bio-17/projects/drug/nf_drug/nfdrug/codes/BFregNN-Cox-for-pyroptosis-in-TNBC/data/ppi_global_graph_'+str(args.score)+'.pkl','wb') as f:
...
with open('/home/bio-17/projects/drug/nf_drug/nfdrug/notebooks/drug_combi_result.txt','a') as f:
